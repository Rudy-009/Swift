//
//  ConcurrencyAnimationView.swift
//  Animation_UIKit
//
...
// MARK: - AnimationPracticeView
final class ConcurrencyAnimationView: UIView {
    ...
    public let retryButton = UIButton().then {
    ...
    private func activateConstraints() {
        NSLayoutConstraint.activate([
            ...
            retryButton.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor, constant: -34),
